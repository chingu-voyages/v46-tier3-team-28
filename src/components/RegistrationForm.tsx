        ...
        <fieldset className="flex flex-col gap-6">
          <fieldset className="flex flex-col gap-2">
            ...
            <input
              ...
              required
              onInvalid={(e) => e.target.setCustomValidity('Please type your active email address.')}
          ...
          <fieldset className="flex flex-col gap-2">
            ...
            <input
              ...
              required
              onInvalid={(e) => e.target.setCustomValidity('Please type your complete name.')}
              onInput={(e) => e.target.setCustomValidity('')}
            />
          </fieldset>
          <fieldset className="flex flex-col gap-2">
            ...
            <input
              ...
              required
              onInvalid={(e) => e.target.setCustomValidity('Please create your new password.')}
              onInput={(e) => e.target.setCustomValidity('')}
            />
          </fieldset>
          <fieldset className="flex flex-col gap-2">
