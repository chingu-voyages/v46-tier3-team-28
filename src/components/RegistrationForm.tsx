  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-[#737373] text-center text-md:text-left lg:text-left xl:text-left">Let’s get you started saving your links!</p>
      ...
      <fieldset className="flex flex-col gap-6">
        ...
        <p className="text-[#737373] text-center">Already have an account? <Link className="text-[#633CFF]" href="register">Login</Link></p>
      </fieldset>
